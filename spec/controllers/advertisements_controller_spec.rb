...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  describe "POST #create" do
    it "increases the number of Advertisement by 1" do
      expect{ post :create, params: { advertisement: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(1..100) } } }.to change(Advertisement, :count).by(1)
    end

    it "assigns the new ad to @advertisement" do
      post :create, params: { advertisement: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(1..100) } }
